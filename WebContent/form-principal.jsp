		...
		<table class="table table-dark table-hover table-bordered"
			...
			<c:forEach var="customer" items="${customers}">
				<tr>
					...
					<td><a
						href="${pageContext.request.contextPath }/cliente?action=editar&id=<c:out value='${customer.id}'/>">Editar</a>
						&nbsp;&nbsp;&nbsp;&nbsp; <a
						href="${pageContext.request.contextPath }/cliente?action=deletar&id=<c:out value='${customer.id}'/>">Deletar</a></td>
				</tr>
			</c:forEach>
		</table>
	</div>
